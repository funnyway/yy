...
elseif($act == 'resume_contact')
{
		...
		if ($show)
		{
			...
			$html.="<li>联系电话：<img src=\"{$_CFG['main_domain']}plus/contact_img.php?act=resume_contact&type=2&id={$id}&token={$token}\"  border=\"0\" align=\"absmiddle\"/><span style='color:#999'>(联系我时请说明是在&nbsp;".$_CFG['site_name']."&nbsp;上看到的)</span></li>";
			...
			$html.="<li>联系电话：".$val['telephone']."<span style='color:#666'>&nbsp;(联系我时请说明是在&nbsp;".$_CFG['site_name']."&nbsp;上看到的)</span></li>";
