<?php /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2015-04-17 10:07 ?D1ú±ê×?ê±?? */  $_templatelite_tpl_vars = $this->_vars;
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <td style=" line-height:220%; color:#666666; padding-left:15px;"><table border="0" cellpadding="0" cellspacing="0" class="link_lan">
      <tr>
        <td width="400"  >系统当前版本：v<?php echo $this->_vars['system_info']['version']; ?>
.<?php echo $this->_vars['system_info']['release']; ?>
<span id="update_notice"></span></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" class="link_lan">
      <tr>
        <td width="400"  >操作系统：<?php echo $this->_vars['system_info']['os']; ?>
</td>
