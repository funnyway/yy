...
// 显示工作地区  
 		$("#jobsCityW").hoverDelay({
		    hoverEvent: function(){
		        $("#divCityCateW").show();
		        var dx = $("#divCityCateW").offset().left; // 获取弹出框的x坐标
		        var dwidth = $("#divCityCateW").outerWidth(true); // 获取弹出框的宽度
		        var lastx = dx + dwidth; // 加上弹出框的宽度获取弹出框最右边的x坐标
  ...
  <div class="rightmain">
	...
	<div class="bbox1">	
	  <div class="addresume">
	    ...
	    <div class="titleH2"><span>个人信息</span></div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableall">
		  <tr>
			...
			<td><div class="righttip">简历名称仅用来区分您的不同简历，不在网站中显示!</div></td>
		  </tr>
		  <tr>
...
" />
			  <div class="publicity" id="publicitydiv">
			    <div class="input_text_70_bg" id="display_name_cn"><?php if ($this->_vars['QISHI']['resume_privacy'] == "1"): ?>完全公开<?php elseif ($this->_vars['QISHI']['resume_privacy'] == "2"): ?>显示编号<?php elseif ($this->_vars['QISHI']['resume_privacy'] == "3"): ?>隐藏名字<?php endif; ?></div>
					<div class="selbox">
						<div class="div" id="1">完全公开</div>
						<div class="div" id="2">显示编号</div>
						<div class="div" id="3">隐藏名字</div>
					</div>
			  </div>
		    </td>
		  </tr>
...
" />
		  ...
		  <tr>
			...
			<td>
			<div>
			 <div class="input_text_200_bg date_input"><?php if ($this->_vars['userprofile']['birthday']):  echo $this->_vars['userprofile']['birthday'];  else: ?>请选择<?php endif; ?></div>
		   ...
		   <tr>
			...
			<td>
				<div style="position:relateve;">
             	 	<div id="education_menu" class="input_text_200_bg"><?php if ($this->_vars['userprofile']['education']):  echo $this->_vars['userprofile']['education_cn'];  else: ?>请选择<?php endif; ?></div>	
...
" />
		   ...
		   <tr>
			...
			<td>
				<div style="position:relateve;">
             	 	<div id="experience_menu" class="input_text_200_bg"><?php if ($this->_vars['userprofile']['experience']):  echo $this->_vars['userprofile']['experience_cn'];  else: ?>请选择<?php endif; ?></div>	
...
" /> </td>
			<td>
				...
				<div class="mobilesend" id="mobilesend">发送验证码</div><div class="mobilesend succeed" id="mobilesendsucceed">已成功发送这验证码，<span id="remainTime">60</span>秒后可重新发送！</div>
				<?php endif; ?>
			</td>
		  </tr>
	    </table>
		  ...
		  <tr>
			...
			<td>&nbsp;<label><input name="email_notify" type="checkbox" value="1" checked="checked"/>接收面试邀请</label></td>
		  </tr>
		  <tr>
			<td align="right">&nbsp;</td>
			<td> <div class="displaymore" id="displaymore">展开选填信息</div></td>
			<td>&nbsp;</td>
		  </tr>
		</table>
...
" />
			<input name="marriage_cn" id="marriage_cn" type="hidden" value="<?php echo $this->_run_modifier($this->_vars['userprofile']['marriage_cn'], 'default', 'plugin', 1, '未婚'); ?>
" />
			  <div class="input_radio<?php if ($this->_vars['userprofile']['marriage'] == 1 || $this->_vars['userprofile']['marriage'] == ''): ?> select<?php endif; ?>" id="1">未婚</div>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tableall" >
		  <tr class="jobmain">
			...
			<td  id="jobsSort" style="position:relative" colspan=2>
				<div class="input_text_200_bg" id="jobText">请选择</div>
		  ...
		  <tr class="jobmain">
		   ...
		   <tr class="jobmain">
			<td width="127" align="right"><span class="nec">工作地区：</span></td>
			<td  id="jobsCityW" style="position:relative;z-index:1;" colspan=2>
				<div class="input_text_200_bg" id="cityTextW">请选择</div>
