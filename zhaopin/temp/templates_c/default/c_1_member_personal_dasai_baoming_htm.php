...
" /> </td>
			...
			<td width="230"><input name="email" type="text" class="input_text_200" id="email" maxlength="30"   value="<?php echo $this->_vars['userprofile']['email']; ?>
" /> </td>
			<td>&nbsp;</td>
		  </tr>
	</tr>
			<tr>
			<td width="125" align="right"><span class="nec">qq号码</span>：</td>
			<td width="230"><input name="qq" type="text" class="input_text_200" id="qq" maxlength="12"   value="<?php echo $this->_vars['userprofile']['qq']; ?>
" /> </td>
			<td>&nbsp;</td>
		  </tr>
		  		  </tr>
