...
"><?php echo $this->_vars['list']['title']; ?>
						...
						<?php endforeach; endif; ?>
							<li><a target="_blank" href="<?php echo $this->_vars['QISHI']['main_domain']; ?>
suggest">意见反馈</a></li>
						</ul>
						<ul>
...
<br />
Powered by <a href="http://www.74cms.com/" target="_blank" style="color:#009900"><em> 74cms v<?php echo $this->_vars['QISHI']['version']; ?>
</em></a><br />
</div>
</div>
<!-- 回到顶部组件 -->
<div class="back_to_top" id="back_to_top">
	...
	<div class="steer">
		<div onclick="javascript:location.href='<?php echo $this->_run_modifier("QS_suggest", 'qishi_url', 'plugin', 1); ?>
'">我要建议</div>
	</div>
</div>
<script>
