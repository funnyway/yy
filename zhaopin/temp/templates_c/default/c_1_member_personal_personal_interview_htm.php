...
<div class="rightmain">
	<div class="bbox1">
	  <div class="interview link_bk">
 	    <div class="topnav">
		 	<div class="titleH1">
			  <div class="h1-title">收到的面试邀请</div>
			</div>
			<div class="navs">
				<a href="?act=<?php echo $this->_vars['act']; ?>
&look="<?php if ($_GET['look'] == ""): ?> class="se"<?php endif; ?>>所有<span<?php if ($_GET['look'] == ""): ?> class="h"<?php endif; ?>>(<?php echo $this->_vars['count']['2']; ?>
)</span></a>
				  <a href="?act=<?php echo $this->_vars['act']; ?>
&look=1"<?php if ($_GET['look'] == "1"): ?> class="se"<?php endif; ?>>未查看<span<?php if ($_GET['look'] == "1"): ?> class="h"<?php endif; ?>>(<?php echo $this->_vars['count']['0']; ?>
)</span></a>
				  <a href="?act=<?php echo $this->_vars['act']; ?>
&look=2"<?php if ($_GET['look'] == "2"): ?> class="se"<?php endif; ?>>已查看<span<?php if ($_GET['look'] == "2"): ?> class="h"<?php endif; ?>>(<?php echo $this->_vars['count']['1']; ?>
)</span></a>
				<div class="clear"></div>
			</div>
	  	</div> 
	  		<div class="toptitle">
			    <div class="t1">邀请时间</div>
				<div class="t2">邀请职位</div>
				<div class="t3">公司名称</div>
				<div class="t4">所属简历</div>
				<div class="t5">面试要求</div>
				<div class="clear"></div>
			</div>
...
</a><?php if ($this->_vars['list']['personal_look'] == "2"): ?><span style="color: #999999">[已查看]</span><?php else: ?><span style="color: #FF6600">[未查看]</span><?php endif; ?></div>
