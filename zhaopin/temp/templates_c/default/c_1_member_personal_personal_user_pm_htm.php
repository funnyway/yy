<?php require_once('D:\amp\www\yy\zhaopin\include\template_lite\plugins\modifier.date_format.php'); $this->register_modifier("date_format", "tpl_modifier_date_format",false);  /* V2.10 Template Lite 4 January 2007  (c) 2005-2007 Mark Dickenson. All rights reserved. Released LGPL. 2015-04-15 10:39 ?D1ú±ê×?ê±?? */ ?>
	...
	<div class="message ">
			...
			<div class="navs link_bk">
				<a href="?act=userprofile">基本资料</a>
				  ...
				  <a href="?act=pm" class="se">消息<?php if ($this->_vars['total']): ?><span class="h">(<?php echo $this->_vars['total']; ?>
)</span><?php endif; ?></a>
		  ...
		  <div class="list link_lan userliststyle">
		  	<div class="title">系统消息<span>(<?php echo $this->_run_modifier($this->_vars['list']['dateline'], 'date_format', 'plugin', 1, "%Y-%m-%d"); ?>
)</span><?php if ($this->_vars['list']['new'] == '1'): ?><u>[新消息]</u><?php endif; ?></div>			
