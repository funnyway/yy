...
" <?php if ($_GET['log_utype'] == "3"): ?>class="select"<?php endif; ?>>猎头顾问</a> 
		<a href="<?php echo $this->_run_modifier("log_utype:4", 'qishi_parse_url', 'plugin', 1); ?>
" <?php if ($_GET['log_utype'] == "4"): ?>class="select"<?php endif; ?>>培训机构</a> 
	  </div>
    </div>
	<div class="list">
...
" <?php if ($_GET['log_type'] == "2007"): ?>class="select"<?php endif; ?>>延期职位</a>
...
" <?php if ($_GET['log_type'] == "1401"): ?>class="select"<?php endif; ?>>个人会员申请课程</a>
...
" <?php if ($_GET['log_type'] == "3202"): ?>class="select"<?php endif; ?>>猎头顾问取消订单</a>
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0" id="list" class="link_lan">
    <tr>
      ...
      <td width="10%"   align="center" class="admin_list_tit"> 登录地址 </td>
...
<span style="color: #CCCCCC">[uid:<?php echo $this->_vars['li']['log_uid']; ?>
		 ...
		 <?php if ($this->_vars['li']['log_utype'] == "1"): ?>企业会员<?php endif; ?>
	 	 ...
	 	 <?php if ($this->_vars['li']['log_utype'] == "3"): ?>猎头顾问<?php endif; ?>
	 	 <?php if ($this->_vars['li']['log_utype'] == "4"): ?>培训机构<?php endif; ?>
		</td>
		 <td    class="admin_list"   align="center">
...
<tr>
		...
		<input name="" type="button" class="admin_submit" id="ButPidel"  value="批量删除" onClick="window.location='?act=pidel_memberslog'"/>
				</td>
